...
func NewQkamuraCommand() *cobra.Command {
	...
	stayDates = flags.IntSlice("stay-dates", []int{20230728,20230729,20230802,20230803,20230804,20230805,20230809,20230810,20230811,20230812}, "stay dates, e.g.: 20210731,20210807")
